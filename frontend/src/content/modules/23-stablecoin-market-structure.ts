...
const content: ModuleContent = {
  ...
  blocks: [
    {
      kind: 'text',
      body: `The Stablecoins topic covered mechanism: fiat-backed versus algorithmic, and why the difference determines survival in a crisis. That framing is necessary but not sufficient for institutional decision-making.\n\nA bank evaluating whether to hold a stablecoin as collateral, a payment company deciding which token to settle with, or a financial institution building on-chain treasury tools needs to understand something different: issuer liability model, reserve economics, distribution control, redemption rights, and regulatory treatment. Five fiat-backed stablecoins targeting a $1 peg can look nearly identical on the surface while differing substantially on all five variables.\n\nFor banks, the stablecoin question is not only "is it backed?" It is: whose liability is it, who can redeem it, who controls the rails, and who captures the economics?\n\nThis topic maps those differences across USDC, USDT, PYUSD, RLUSD, and Open USD — the stablecoin announced by a consortium including Visa, Mastercard and Coinbase in June 2026. The question is not which one is best. The question is which characteristics matter for a given institutional use case, and why.`,
    },
    {
      kind: 'matrix',
        ...
        items: [
          {
            ...
            values: [
              ...
              'Most regulatory-forward major stablecoin among those listed here. US money transmitter licences across key states. GENIUS Act-aligned. MiCA EU entity active.',
          ...
          },
          {
            ...
            values: [
              ...
              'Limited EU and US regulatory footprint. No MiCA registration as of mid-2026. Operates under more permissive offshore frameworks. Regulatory posture is the primary institutional concern in regulated markets.',
    ...
    },
    {
      ...
      data: {
        ...
        whyItMatters: `Single-issuer stablecoins share one economic logic: the issuer mints tokens, manages reserves, retains the yield, and uses revenue to fund compliance and distribution globally. That model produces both USDC and USDT — different in regulatory posture but identical in reserve economics structure. Open USD proposes a different logic: the economics of adoption are shared with the participants who distribute the token. This changes who is commercially incentivised to drive adoption, which could attract a large merchant and payment network around a shared stablecoin. The important caveats are real: governance at scale in a large consortium is complex, shared-economics arrangements require clear legal and tax treatment across participating jurisdictions, and Visa and Mastercard's participation could reflect hedging across multiple stablecoin models rather than a commitment to one. The design is important as a structural proposition — whether it operates as described remains to be demonstrated.`,
    ...
    },
    {
      ...
      data: {
        tone: 'strategy',
        body: `Stablecoin choice is not a technology decision. It is a counterparty, liability and regulatory decision. The most liquid token is not the same as the most transparent. The most institutionally familiar distribution networks are not the most proven in production. A bank holding a stablecoin as collateral takes on credit risk to the issuer, operational risk to the reserve management process, and regulatory risk to the issuing entity's compliance posture. None of those risks disappear because the token settles quickly on-chain. The critical distinction remains: deposit tokens keep the customer's claim against a regulated bank balance sheet with deposit insurance. Stablecoins of every type — single-issuer or consortium — place the claim against a non-bank entity with no deposit insurance and redemption certainty entirely dependent on reserve quality and issuer continuity.`,
      },
    },
    {
      kind: 'matrix',
    ...
    },
    {
      ...
      body: `The stablecoin market is moving from token issuance to network control. USDT demonstrated the power of liquidity and global reach, built without regulatory favour. USDC demonstrated that regulated reserve transparency and institutional on-boarding infrastructure produce a different kind of adoption — slower to grow but more suitable for regulated counterparties. PYUSD and RLUSD show that platform companies and payment networks want their own settlement assets, for their own users, on their own terms.\n\nOpen USD is important because it proposes a different competitive dynamic: not issuing the best token, but aligning the largest distribution network around shared economics. If the publicly reported structure operates as described, it changes who benefits commercially from driving stablecoin adoption — which is precisely the incentive that could attract Visa, Mastercard and a large merchant base. Whether it achieves that is unproven.\n\nNone of this is settled. Open USD's governance at consortium scale, USDT's long-term regulatory viability in the EU and UK, and RLUSD's adoption outside Ripple's existing network are all open questions as of mid-2026. What is clear is that the stablecoin category now has enough distinct economic and structural models that treating all fiat-backed stablecoins as interchangeable is a material analytical error.\n\nFor deposit-taking banks, the framing in the Deposit Tokens topic remains the right starting point: deposit tokens are not in this competition. The question for banks is not which stablecoin to adopt but how to position tokenised commercial bank money relative to a stablecoin market that is consolidating around network control.`,
    },
    {
      kind: 'quiz',
