  ...
  blocks: [
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          { id: 'build', label: 'Build your own token', color: '#7AA7D9', values: [`Full control, keeps the deposit on balance sheet (tokenized deposit)`, `Significant build cost; only works if customers actually adopt it over USDC/USDT`, `JPMorgan Kinexys (publicly reported volumes in the billions daily); Société Générale FORGE (digital bonds issued on Ethereum public chain)`] },
