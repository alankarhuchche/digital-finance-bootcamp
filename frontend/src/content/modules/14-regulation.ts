...
const content: ModuleContent = {
  ...
  blocks: [
    {
      kind: 'text',
      body: `Topic 03 showed who regulation actually protects: customers, banks, central banks, economies. This topic is the rulebooks themselves, covering what they actually require, the timeline that has been forcing the industry's hand, and the jurisdictional chess game that issuers and exchanges play to find the friendliest regime.`,
    },
    {
      kind: 'timeline',
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          { id: 'mica', label: 'MiCA (EU)', color: '#7AA7D9', values: [`Full crypto-asset framework, of which stablecoins are one part`, `1:1 backing, with a meaningful share required in EU bank deposits`, `Authorized e-money or credit institution, per member state`, `Tether's reserve strategy leans on yield-bearing assets like T-bills, not low-yield EU bank deposits, so the EU rule cuts directly into the profit model`] },
    ...
    },
    {
      ...
      body: `<b>FATF's Travel Rule</b> requires crypto transfers above a threshold to carry sender and recipient information. It is the same idea as wire transfer compliance in traditional banking, and the source of most of DeFi and self-custody's compliance friction, since a peer-to-peer wallet transfer has no natural place to attach that data. <b>Basel III's crypto exposure rules</b> set how much capital a bank must hold against crypto holdings, punitively high for unbacked crypto assets, which is a major reason banks have been slow to hold crypto directly on balance sheet even when they are happy to offer customer access to it.`,
    },
    {
      kind: 'text',
      heading: 'AML/KYC: the compliance cost nobody talks about',
      body: `For a small crypto firm, AML/KYC compliance is not just a legal checkbox. It is a survival-level expense. Annual compliance costs for a small to mid-size crypto company typically range from $25,000 to $500,000+, covering transaction monitoring software (Chainalysis, Elliptic, or TRM Labs licenses alone run $50K–$200K/year), a dedicated compliance officer ($80K–$150K salary), external audit fees, and legal counsel for SAR filings and regulatory responses. For context, a 10-person crypto startup spending $250K/year on compliance is allocating roughly 15–25% of its operating budget to regulatory overhead before writing a single line of product code. This cost asymmetry is one reason the industry is consolidating. Only well-capitalized firms can absorb the compliance burden, which ironically pushes the market toward the same centralization that crypto was designed to avoid.`,
    },
    {
      kind: 'text',
      heading: '“Same risk, same regulation”',
      body: `Despite their differences in approach, regulators globally are converging on one principle: if a crypto product creates the same risk as a traditional financial product, it should face the same regulation. A stablecoin that functions like a money market fund should be regulated like one. A crypto exchange that matches buyers and sellers should be regulated like a securities exchange. A lending protocol that takes deposits and makes loans should face bank-like oversight. This principle, sometimes called "same activity, same risk, same regulation," is now explicitly endorsed by the FSB, the BIS, the EU (in MiCA's preamble), and increasingly by US regulators. The practical implication is that the era of crypto operating in a regulatory vacuum is ending, not because regulators have invented new rules, but because they are applying existing ones.
...
Regulation sets the rules. But one question cuts across every rule: how much should the system know about you? The next topic tackles privacy, the elephant in every CBDC and blockchain room.`,
    },
    {
      ...
      data: {
        ...
        dateRange: '2017–2024',
        whatHappened: `Binance launched in 2017 with no fixed headquarters and a deliberate strategy of operating across jurisdictions without obtaining local licenses. By 2021 it faced regulatory warnings or bans from the UK FCA, Japan's FSA, the Netherlands, Germany, Italy, and others. In 2023 the US DOJ and CFTC brought charges, and Binance agreed to a $4.3 billion settlement, the largest in crypto history, for AML and sanctions violations. CEO Changpeng Zhao (CZ) pled guilty to failing to maintain an effective AML program and stepped down. Under new CEO Richard Teng, Binance pivoted to a compliance-first strategy, obtaining or applying for licenses in France (DASP registration), Dubai (VASP license from VARA), Japan (through a local subsidiary), and multiple other jurisdictions. The company hired over 750 compliance staff by mid-2024 and implemented Chainalysis and internal monitoring systems across all markets.`,
        whyItMatters: `Binance's arc is the crypto industry's regulatory journey in miniature. The early model of operating globally, moving fast and dealing with regulators later worked until it didn't. The $4.3B settlement proved that "regulatory arbitrage through avoidance" has a price ceiling. Binance's post-settlement pivot also demonstrated that even the largest crypto firm in the world ultimately concluded that licensing and compliance were cheaper than enforcement.`,
