...
<p>What follows is not a summary of this site. It is an opinionated reading of where digital finance is heading: where I think the weight of evidence points, where the consensus is right, and where I believe it is mistaken.</p>`,
    },
    {
      kind: 'callout',
...
<p>I expect deposit tokens to absorb a meaningful share of institutional settlement, particularly intraday liquidity, intrabank transfers and collateral mobility, while stablecoins retain the open-access, cross-border, retail-adjacent flows.</p>`,
    ...
    },
    {
      ...
      body: `<p>In jurisdictions with mature faster payment systems, the UK with FPS, India with UPI, the EU with TIPS, the US with FedNow, the speed argument for retail CBDC is already solved. Consumers can send money in seconds. The question then becomes what a retail CBDC offers that existing infrastructure does not.</p>
...
<p>Getting the cash leg right is what makes the tokenised capital markets thesis work. Getting it wrong, or leaving it to stablecoins with uncertain legal finality, risks building a new financial market infrastructure on a fragile monetary foundation.</p>`,
    },
    {
      kind: 'text',
      heading: `Interoperability as the strategic battleground`,
      body: `<p>The industry has learned, painfully, that no single blockchain will win. Ethereum, Solana, Canton, HQLAX, Fnality and various permissioned Hyperledger deployments each serve different constituencies with different trade-offs. The fragmentation is structural, not temporary.</p>
<p>This means the winning layer is unlikely to be a ledger. It is more likely to be the control and interoperability layer that lets regulated institutions move value across ledgers, bridging chains, orchestrating settlement and enforcing compliance, without weakening legal finality or operational accountability.</p>
        ...
        items: [
          {
            ...
            values: [
              ...
              'Trapped liquidity costs are rising as rates stay elevated, and tokenised intraday settlement can free working capital',
            ],
          },
          {
            id: 'collateral',
            ...
            values: [
              ...
              'T+1 US settlement compressed collateral windows, and real-time pledging is becoming a competitive necessity',
            ],
          },
          {
            id: 'crossborder',
          ...
          },
          {
            ...
            values: [
              ...
              'BlackRock BUIDL and Franklin Templeton have proven demand, and clients expect yield-bearing digital cash',
            ],
          },
          {
            id: 'dvp',
            ...
            values: [
              ...
              'Regulators (MAS, BdF, SNB, BoE) are running supervised sandboxes, and early participants shape the standards',
            ],
          },
        ],
      },
...
<li><strong>A dominant L1 could emerge.</strong> If one chain achieves sufficient network effects in institutional finance, the way SWIFT did in messaging, the interoperability thesis weakens.</li>
        ...
        questions: [
          {
            ...
            correctIndex: 1,
            explanation: `The central thesis is that the liability model, meaning who bears the risk and who guarantees finality, matters more than the underlying technology or speed improvements.`,
          },
          {
