    ...
    },
    {
      ...
      data: {
        ...
        items: [
          ...
          { id: 'wholesale', label: 'Wholesale CBDC', color: '#7AA7D9', values: [`Banks and financial institutions only`, `Settling large-value interbank and cross-border transactions on a shared ledger`, `Central bank operates the settlement layer; participating banks interact through APIs or nodes`, 'Project Agora, mBridge'] },
        ],
      },
    },
    {
