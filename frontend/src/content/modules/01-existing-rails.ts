...
const content: ModuleContent = {
  ...
  blocks: [
    ...
    {
      kind: 'text',
      body: `These are the rails everything currently runs on. The next topic asks: what forms of money are people proposing to run on new rails — and how do they compare to what you already use?`,
    },
    {
      kind: 'quiz',
