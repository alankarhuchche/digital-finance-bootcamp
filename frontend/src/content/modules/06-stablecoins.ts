...
const content: ModuleContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          ...
          { id: 'fractional', label: 'Fractional-algorithmic', color: '#E8A33D', values: [`Partially collateralized (e.g. 90% real assets, 10% algorithmic), with the ratio adjusting based on market confidence`, `Redeem for a mix of collateral and newly minted governance tokens`, `If confidence drops, the algorithmic portion expands just when it is least trustworthy`, 'Frax (FRAX)'] },
    ...
    },
    {
      ...
      data: {
        tone: 'reality',
        body: `Stablecoins are useful because they expose a real market frustration: cross-border value movement is still too slow and too expensive. But on-chain speed is not settlement finality. USDC's SVB depeg and UST's collapse teach the same lesson from two different mechanisms. Redemption certainty depends entirely on what is actually backing the token and how fast you can prove it. Treat "fiat-backed" as a spectrum, not a guarantee, and check the audit quality before the marketing.`,
      },
    },
    {
      kind: 'text',
    ...
    },
    {
      ...
      data: {
        questions: [
          ...
          { question: 'What is the key difference between Tether’s reserve reporting and Circle’s?', options: ['Tether publishes more frequently than Circle', 'Circle uses Deloitte attestations under AICPA standards, while Tether uses BDO Italia attestations that fall short of full GAAP audits', 'There is no meaningful difference', 'Tether is audited by the SEC directly'], correctIndex: 1, explanation: 'Circle publishes monthly attestations by Deloitte (Big Four). Tether publishes quarterly attestations by BDO Italia, which are point-in-time snapshots, not full audits. Tether has never completed a full GAAP audit.' },
