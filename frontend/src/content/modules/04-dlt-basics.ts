...
const content: ModuleContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          ...
          { id: 'pos', label: 'Proof of Stake', color: '#5FB3A3', values: ['Validators who stake the native token', 'Higher. Ethereum L1: 15–65 tx/sec. Solana publishes a theoretical maximum of 65,000 tx/sec; real-world sustained throughput is lower. Both vary by network conditions.', 'Low', 'Ethereum, Solana', '~13 min on Ethereum (2 epochs); sub-second on Solana (~0.4s)'] },
        ...
        items: [
          ...
          },
          {
            ...
            values: [
              ...
              'Sub-second (~0.4s). Solana documentation reports over $1 trillion in stablecoin volume in 2025. Stablecoin volume is not the same as regulated bank payment adoption.',
              'High-throughput consumer and merchant stablecoin payments. Regulatory controls must be layered at the application level. Validator concentration and uptime history are watch-outs for institution-grade use.',
            ],
          },
          {
            id: 'besu',
    ...
    },
    {
      ...
      body: `In RTGS systems like CHAPS, settlement is immediate and irrevocable. On public blockchains, finality is often probabilistic: a transaction becomes progressively less likely to reverse as more blocks accumulate on top. Specific timings: Bitcoin after six confirmations (~60 minutes); Ethereum after two epochs (~13 minutes post-Merge); Solana sub-second (~0.4s). Permissioned networks — Besu, Canton, Corda — offer immediate finality once consensus or the notary confirms.\n\nThe gap between public-chain technical finality and RTGS settlement is narrowing. Legal and operational finality are separate questions from technical confirmation. For atomic settlement — settling both legs of a trade simultaneously — this distinction is critical. See the Settlement topic.`,
    },
    {
      kind: 'case',
